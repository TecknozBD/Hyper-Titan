...
| 1    | RST_N    | RW     | 0           | Active low reset for efficiency core |
...
| 1    | RST_N    | RW     | 0           | Active low reset for performance core |
| 31:2 | Reserved | -      | 0           | Reserved                              |
...
| 1    | RST_N    | RW     | 0           | Active low reset for core link |
| 31:2 | Reserved | -      | 0           | Reserved                       |
...
| ---- | -------- | ------ | ----------- | -------------------------------- |
| 0    | Reserved | -      | 0           | Reserved                         |
| 1    | RST_N    | RW     | 0           | Active low reset for system link |
| 31:2 | Reserved | -      | 0           | Reserved                         |
